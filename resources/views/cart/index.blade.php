                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <div class="mt-3 flex flex-col gap-2 w-auto max-w-fit">
                                            ...
                                            <div class="inline-flex items-center gap-1">
                                                {{-- Botão diminuir --}}
                                                <button type="button"
                                                    class="qty-btn inline-flex items-center justify-center border border-gray-400 rounded w-[3ch] h-[3ch] text-sm font-bold text-gray-800 hover:bg-gray-50"
                                                ...
                                                <input type="text"
                                                    class="qty-input border border-gray-400 rounded w-[3ch] h-[3ch] flex-none text-center text-sm font-mono tabular-nums outline-none"
